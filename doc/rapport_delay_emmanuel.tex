...
L'application de l'algorithme du cours se fait alors presque mot à mot, en utilisant les fonctions définies dans \texttt{alphabet.h} pour parcourir l'ensemble des lettres de l'alphabet. La seule différence est que j'initialise la liste d'états du DFA par un état puits au lieu de l'$\varepsilon$-transition de l'état initial du NFA. L'intérêt de cet état sera décrit en \ref{dfa_graph}.
